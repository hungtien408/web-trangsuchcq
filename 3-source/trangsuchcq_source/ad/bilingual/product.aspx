...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
        ...
        <asp:RadGrid ID="RadGrid1" AllowMultiRowSelection="True" runat="server" Culture="vi-VN"
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                <Columns>
                    ...
                    <asp:GridBoundColumn DataField="ProductGenderName" HeaderText="Giới Tính" SortExpression="ProductGenderName" />
                    <asp:GridBoundColumn DataField="ProductMaterialName" HeaderText="Chất Liệu" SortExpression="ProductMaterialName" />
                    <asp:GridBoundColumn DataField="ProductMaterialColorName" HeaderText="Màu Chất Liệu" SortExpression="ProductMaterialColorName" />
                    <asp:GridBoundColumn DataField="ProductSpeciesName" HeaderText="Chủng Loại" SortExpression="ProductSpeciesName" />
                    <asp:GridBoundColumn DataField="ProductStoneColorName" HeaderText="Màu Đá Chính" SortExpression="ProductStoneColorName" />
                    <asp:GridBoundColumn DataField="ProductStoneCategoryName" HeaderText="Loại Đá Chính" SortExpression="ProductStoneCategoryName" />
                    <asp:GridBoundColumn DataField="ProductGoldenAgeName" HeaderText="Tuổi Vàng" SortExpression="ProductGoldenAgeName" />
                    ...
                    <asp:GridTemplateColumn DataField="IsHot" HeaderText="Ưa chuộng" SortExpression="IsHot">
                        <ItemTemplate>
                                                ...
                                                <table class="search">
                                                    <tr>
                                                        ...
                                                        <td runat="server">
                                                            ...
                                                            <span class="required">(Kích thước 185px x 185px)</span>
                                                    ...
                                                    <tr>
                                                        <td class="left" colspan="2">
                                                            ...
                                                            &nbsp;&nbsp;
                                                            <asp:CheckBox ID="chkIsHot" runat="server" CssClass="checkbox" Text=" Ưa chuộng" Checked='<%# (Container is GridEditFormInsertItem) ? false : (string.IsNullOrEmpty(Eval("IsHot").ToString()) ? false : Eval("IsHot"))%>' />
                                                            &nbsp;&nbsp;
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtProductName"
                                            Display="Dynamic" ErrorMessage="Nhập tên sản phẩm" SetFocusOnError="true">*</asp:RequiredFieldValidator>--%>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:RadComboBox Filter="Contains" ID="ddlProductGender" runat="server" DataSourceID="odsProductGender"
                                                                DataTextField="ProductGenderName" DataValueField="ProductGenderID" Width="504px"
                                                                OnDataBound="DropDownList_DataBound" EmptyMessage="- Chọn -">
                                                            </asp:RadComboBox>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:RadComboBox Filter="Contains" ID="ddlProductMaterialColor" runat="server" DataSourceID="odsProductMaterialColor"
                                                                DataTextField="ProductMaterialColorName" DataValueField="ProductMaterialColorID" Width="504px"
                                                                OnDataBound="DropDownList_DataBound" EmptyMessage="- Chọn -">
                                                            </asp:RadComboBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:RadComboBox Filter="Contains" ID="ddlProductSpecies" runat="server" DataSourceID="odsProductSpecies"
                                                                DataTextField="ProductSpeciesName" DataValueField="ProductSpeciesID" Width="504px"
                                                                OnDataBound="DropDownList_DataBound" EmptyMessage="- Chọn -">
                                                            </asp:RadComboBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:RadComboBox Filter="Contains" ID="ddlProductStoneColor" runat="server" DataSourceID="odsProductStoneColor"
                                                                DataTextField="ProductStoneColorName" DataValueField="ProductStoneColorID" Width="504px"
                                                                OnDataBound="DropDownList_DataBound" EmptyMessage="- Chọn -">
                                                            </asp:RadComboBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:RadComboBox Filter="Contains" ID="ddlProductStoneCategory" runat="server" DataSourceID="odsProductStoneCategory"
                                                                DataTextField="ProductStoneCategoryName" DataValueField="ProductStoneCategoryID" Width="504px"
                                                                OnDataBound="DropDownList_DataBound" EmptyMessage="- Chọn -">
                                                            </asp:RadComboBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:RadComboBox Filter="Contains" ID="ddlProductGoldenAge" runat="server" DataSourceID="odsProductGoldenAge"
                                                                DataTextField="ProductGoldenAgeName" DataValueField="ProductGoldenAgeID" Width="504px"
                                                                OnDataBound="DropDownList_DataBound" EmptyMessage="- Chọn -">
                                                            </asp:RadComboBox>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td class="left" valign="top">Thông tin sản phẩm
                                                        </td>
                                                        <td>
                                                            <asp:RadEditor ID="txtInfoProduct" ContentFilters="ConvertCharactersToEntities,ConvertToXhtml,OptimizeSpans,IndentHTMLContent,ConvertFontToSpan,IECleanAnchors,FixUlBoldItalic,RemoveScripts,FixEnclosingP"
                                                                runat="server" Language="vi-VN" Skin="Office2007" Width="503px" Content='<%# Bind("InfoProduct") %>'>
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtProductName"
                                            Display="Dynamic" ErrorMessage="Nhập tên sản phẩm" SetFocusOnError="true">*</asp:RequiredFieldValidator>--%>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:RadEditor ID="txtInfoProductEn" ContentFilters="ConvertCharactersToEntities,ConvertToXhtml,OptimizeSpans,IndentHTMLContent,ConvertFontToSpan,IECleanAnchors,FixUlBoldItalic,RemoveScripts,FixEnclosingP"
                                                                    runat="server" Language="vi-VN" Skin="Office2007" Width="503px" Content='<%# Bind("InfoProductEn") %>'>
                                                                    <ImageManager DeletePaths="~/Uploads/Image/" UploadPaths="~/Uploads/Image/" ViewPaths="~/Uploads/Image/"
                                                                        MaxUploadFileSize="1024000" />
                                                                    <FlashManager DeletePaths="~/Uploads/Video/" UploadPaths="~/Uploads/Video/" ViewPaths="~/Uploads/Video/" />
                                                                    <DocumentManager DeletePaths="~/Uploads/File/" UploadPaths="~/Uploads/File/" ViewPaths="~/Uploads/File/"
                                        ...
                                        <div class="sub_box">
                                            ...
                                            <div class="cont">
                                                <asp:RadAjaxPanel ID="RadAjaxPanel2" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
                                                    ...
                                                    <span class="required">(Kích thước 508px x 504px)</span>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="ProductSelectAll1"
        ...
        <InsertParameters>
            ...
            <asp:Parameter Name="InfoProduct" Type="String" />
            ...
            <asp:Parameter Name="InfoProductEn" Type="String" />
            ...
            <asp:Parameter Name="ProductGenderID" Type="String" />
            <asp:Parameter Name="ProductMaterialColorID" Type="String" />
            <asp:Parameter Name="ProductSpeciesID" Type="String" />
            <asp:Parameter Name="ProductStoneColorID" Type="String" />
            <asp:Parameter Name="ProductStoneCategoryID" Type="String" />
            <asp:Parameter Name="ProductGoldenAgeID" Type="String" />
