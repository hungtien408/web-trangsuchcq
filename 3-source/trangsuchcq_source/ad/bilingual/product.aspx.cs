...
public partial class ad_single_product : System.Web.UI.Page
{
    ...
    protected void RadGrid1_ItemCommand(object sender, GridCommandEventArgs e)
    {
        ...
        else if (e.CommandName == "PerformInsert" || e.CommandName == "Update")
        {
            ...
            string InfoProduct = HttpUtility.HtmlDecode(FCKEditorFix.Fix(((RadEditor)row.FindControl("txtInfoProduct")).Content.Trim()));
            ...
            string ProductGenderID = ((RadComboBox)row.FindControl("ddlProductGender")).SelectedValue;
            string ProductMaterialColorID = ((RadComboBox)row.FindControl("ddlProductMaterialColor")).SelectedValue;
            string ProductSpeciesID = ((RadComboBox)row.FindControl("ddlProductSpecies")).SelectedValue;
            string ProductStoneColorID = ((RadComboBox)row.FindControl("ddlProductStoneColor")).SelectedValue;
            string ProductStoneCategoryID = ((RadComboBox)row.FindControl("ddlProductStoneCategory")).SelectedValue;
            string ProductGoldenAgeID = ((RadComboBox)row.FindControl("ddlProductGoldenAge")).SelectedValue;
            ...
            string InfoProductEn = HttpUtility.HtmlDecode(FCKEditorFix.Fix(((RadEditor)row.FindControl("txtInfoProductEn")).Content.Trim()));
            ...
            else
            {
                ...
                dsUpdateParam["ProductGenderID"].DefaultValue = ProductGenderID;
                dsUpdateParam["ProductMaterialColorID"].DefaultValue = ProductMaterialColorID;
                dsUpdateParam["ProductSpeciesID"].DefaultValue = ProductSpeciesID;
                dsUpdateParam["ProductStoneColorID"].DefaultValue = ProductStoneColorID;
                dsUpdateParam["ProductStoneCategoryID"].DefaultValue = ProductStoneCategoryID;
                dsUpdateParam["ProductGoldenAgeID"].DefaultValue = ProductGoldenAgeID;
