<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="productgender.aspx.cs" Inherits="ad_single_partner" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
    ...
    <asp:RadAjaxPanel ID="RadAjaxPanel1" runat="server" ClientEvents-OnRequestStart="conditionalPostback">
        <asp:Panel ID="pnlSearch" DefaultButton="btnSearch" runat="server" Visible="false">
            ...
            <table class="search">
                <tr>
                    ...
                    <td>
                        <asp:RadTextBox ID="txtSearchProductGenderName" runat="server" Width="200px">
                        </asp:RadTextBox>
                    </td>
                </tr>
            </table>
                ...
                <Columns>
                    ...
                    <asp:GridTemplateColumn HeaderStyle-Width="1%" HeaderText="STT">
                        <ItemTemplate>
                            ...
                            <asp:HiddenField ID="hdnProductGenderID" runat="server" Value='<%# Eval("ProductGenderID") %>' />
                            <asp:HiddenField ID="hdnProductGenderImage" runat="server" Value='<%# Eval("ProductGenderImage") %>' />
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    <asp:GridBoundColumn HeaderText="ID" DataField="ProductGenderID" SortExpression="ProductGenderID" Visible="false">
                    </asp:GridBoundColumn>
                    <asp:GridTemplateColumn HeaderText="Giới Tính" DataField="ProductGenderName"
                        SortExpression="ProductGenderName">
                        <ItemTemplate>
                            <asp:Label ID="lblProductGenderName" runat="server" Text='<%# Eval("ProductGenderName")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    <asp:GridTemplateColumn HeaderText="Giới Tính(Tiếng Anh)" Visible="false"
                        DataField="ProductGenderNameEn" SortExpression="ProductGenderNameEn">
                        <ItemTemplate>
                            <asp:Label ID="lblProductGenderNameEn" runat="server" Text='<%# Eval("ProductGenderNameEn")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    ...
                    <asp:GridTemplateColumn DataField="ProductGenderImage" HeaderText="Ảnh"
                        SortExpression="ProductGenderImage" Visible="false">
                        <ItemTemplate>
                            <asp:Panel ID="Panel1" runat="server" Visible='<%# string.IsNullOrEmpty( Eval("ProductGenderImage").ToString()) ? false : true %>'
                                Width="95">
                                <img alt="" src='<%# "~/res/ProductGender/" + Eval("ProductGenderImage") %>' width="80"
                                    runat="server" visible='<%# string.IsNullOrEmpty(Eval("ProductGenderImage").ToString()) ? false : true %>' />
                                <asp:LinkButton ID="lnkDeleteImage" runat="server" rel='<%#  Eval("ProductGenderID") + "#" + Eval("ProductGenderImage") %>'
                ...
                <EditFormSettings EditFormType="Template">
                    <FormTemplate>
                        <asp:Panel ID="Panel1" runat="server" DefaultButton="lnkUpdate">
                            <h3 class="searchTitle">Thông Tin Giới Tính</h3>
                            <table class="search">
                                <tr class="invisible">
                                    ...
                                    <td>
                                        <asp:HiddenField ID="hdnProductGenderID" runat="server" Value='<%# Eval("ProductGenderID") %>' />
                                        <asp:HiddenField ID="hdnProductGenderImage" runat="server" Value='<%# Eval("ProductGenderImage") %>' />
                                        <asp:RadUpload ID="FileProductGenderImage" runat="server" ControlObjectsVisibility="None"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtProductGenderName" runat="server" Text='<%# Bind("ProductGenderName") %>'
                                ...
                                <asp:Panel ID="Panel2" runat="server" Visible="false">
                                    ...
                                    <tr>
                                        <td class="left" valign="top">Giới Tính(En)
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtProductGenderNameEn" runat="server" Text='<%# Bind("ProductGenderNameEn") %>'
                                                Width="500px"></asp:TextBox>
                                        </td>
                                    </tr>
                                </asp:Panel>
        ...
        <asp:RadInputManager ID="RadInputManager1" runat="server">
            <asp:TextBoxSetting EmptyMessage="Giới Tính ...">
                <TargetControls>
                    <asp:TargetInput ControlID="txtProductGenderName" />
                </TargetControls>
            </asp:TextBoxSetting>
            <asp:TextBoxSetting EmptyMessage="Giới Tính(En) ...">
                <TargetControls>
                    <asp:TargetInput ControlID="txtProductGenderNameEn" />
                </TargetControls>
            </asp:TextBoxSetting>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="ProductGenderDelete"
        SelectMethod="ProductGenderSelectAll" TypeName="TLLib.ProductGender" UpdateMethod="ProductGenderUpdate"
        InsertMethod="ProductGenderInsert">
        <DeleteParameters>
            <asp:Parameter Name="ProductGenderID" Type="String" />
        </DeleteParameters>
        <InsertParameters>
            <asp:Parameter Name="ProductGenderName" Type="String" />
            <asp:Parameter Name="ProductGenderNameEn" Type="String" />
            <asp:Parameter Name="ConvertedProductGenderName" Type="String" />
            <asp:Parameter Name="ProductGenderImage" Type="String" />
            <asp:Parameter Name="IsAvailable" Type="String" />
            <asp:Parameter Name="Priority" Type="String" />
            <asp:Parameter Name="ProductID" Type="String" />
        </InsertParameters>
        <SelectParameters>
            <asp:ControlParameter ControlID="txtSearchProductGenderName" Name="ProductGenderName"
