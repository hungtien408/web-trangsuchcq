<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="productgoldenage.aspx.cs" Inherits="ad_single_partner" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
    ...
    <asp:RadAjaxPanel ID="RadAjaxPanel1" runat="server" ClientEvents-OnRequestStart="conditionalPostback">
        <asp:Panel ID="pnlSearch" DefaultButton="btnSearch" runat="server" Visible="false">
            ...
            <table class="search">
                <tr>
                    ...
                    <td>
                        <asp:RadTextBox ID="txtSearchProductGoldenAgeName" runat="server" Width="200px">
                        </asp:RadTextBox>
                    </td>
                </tr>
            </table>
        ...
        <asp:RadGrid ID="RadGrid1" AllowMultiRowSelection="True" runat="server" Culture="vi-VN"
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                DataKeyNames="ProductGoldenAgeID">
                ...
                <Columns>
                    ...
                    <asp:GridTemplateColumn HeaderStyle-Width="1%" HeaderText="STT">
                        <ItemTemplate>
                            ...
                            <asp:HiddenField ID="hdnProductGoldenAgeID" runat="server" Value='<%# Eval("ProductGoldenAgeID") %>' />
                            <asp:HiddenField ID="hdnProductGoldenAgeImage" runat="server" Value='<%# Eval("ProductGoldenAgeImage") %>' />
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    <asp:GridBoundColumn HeaderText="ID" DataField="ProductGoldenAgeID" SortExpression="ProductGoldenAgeID" Visible="false">
                    </asp:GridBoundColumn>
                    <asp:GridTemplateColumn HeaderText="Tuổi Vàng" DataField="ProductGoldenAgeName"
                        SortExpression="ProductGoldenAgeName">
                        <ItemTemplate>
                            <asp:Label ID="lblProductGoldenAgeName" runat="server" Text='<%# Eval("ProductGoldenAgeName")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    <asp:GridTemplateColumn HeaderText="Tuổi Vàng(Tiếng Anh)" Visible="false"
                        DataField="ProductGoldenAgeNameEn" SortExpression="ProductGoldenAgeNameEn">
                        <ItemTemplate>
                            <asp:Label ID="lblProductGoldenAgeNameEn" runat="server" Text='<%# Eval("ProductGoldenAgeNameEn")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    ...
                    <asp:GridTemplateColumn DataField="ProductGoldenAgeImage" HeaderText="Ảnh"
                        SortExpression="ProductGoldenAgeImage" Visible="false">
                        <ItemTemplate>
                            <asp:Panel ID="Panel1" runat="server" Visible='<%# string.IsNullOrEmpty( Eval("ProductGoldenAgeImage").ToString()) ? false : true %>'
                                Width="95">
                                <img alt="" src='<%# "~/res/ProductGoldenAge/" + Eval("ProductGoldenAgeImage") %>' width="80"
                                    runat="server" visible='<%# string.IsNullOrEmpty(Eval("ProductGoldenAgeImage").ToString()) ? false : true %>' />
                                <asp:LinkButton ID="lnkDeleteImage" runat="server" rel='<%#  Eval("ProductGoldenAgeID") + "#" + Eval("ProductGoldenAgeImage") %>'
                ...
                <EditFormSettings EditFormType="Template">
                    <FormTemplate>
                        <asp:Panel ID="Panel1" runat="server" DefaultButton="lnkUpdate">
                            <h3 class="searchTitle">Thông Tin Tuổi Vàng</h3>
                            <table class="search">
                                <tr class="invisible">
                                    ...
                                    <td>
                                        <asp:HiddenField ID="hdnProductGoldenAgeID" runat="server" Value='<%# Eval("ProductGoldenAgeID") %>' />
                                        <asp:HiddenField ID="hdnProductGoldenAgeImage" runat="server" Value='<%# Eval("ProductGoldenAgeImage") %>' />
                                        <asp:RadUpload ID="FileProductGoldenAgeImage" runat="server" ControlObjectsVisibility="None"
                                ...
                                <tr>
                                    <td class="left" valign="top">Tuổi Vàng
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtProductGoldenAgeName" runat="server" Text='<%# Bind("ProductGoldenAgeName") %>'
                                ...
                                <asp:Panel ID="Panel2" runat="server" Visible="false">
                                    ...
                                    <tr>
                                        <td class="left" valign="top">Tuổi Vàng(En)
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtProductGoldenAgeNameEn" runat="server" Text='<%# Bind("ProductGoldenAgeNameEn") %>'
                                                Width="500px"></asp:TextBox>
                                        </td>
                                    </tr>
                                </asp:Panel>
        ...
        <asp:RadInputManager ID="RadInputManager1" runat="server">
            <asp:TextBoxSetting EmptyMessage="Tuổi Vàng ...">
                <TargetControls>
                    <asp:TargetInput ControlID="txtProductGoldenAgeName" />
                </TargetControls>
            </asp:TextBoxSetting>
            <asp:TextBoxSetting EmptyMessage="Tuổi Vàng ...">
                <TargetControls>
                    <asp:TargetInput ControlID="txtProductGoldenAgeNameEn" />
                </TargetControls>
            </asp:TextBoxSetting>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="ProductGoldenAgeDelete"
        SelectMethod="ProductGoldenAgeSelectAll" TypeName="TLLib.ProductGoldenAge" UpdateMethod="ProductGoldenAgeUpdate"
        InsertMethod="ProductGoldenAgeInsert">
        <DeleteParameters>
            <asp:Parameter Name="ProductGoldenAgeID" Type="String" />
        </DeleteParameters>
        <InsertParameters>
            <asp:Parameter Name="ProductGoldenAgeName" Type="String" />
            <asp:Parameter Name="ProductGoldenAgeNameEn" Type="String" />
            <asp:Parameter Name="ConvertedProductGoldenAgeName" Type="String" />
            <asp:Parameter Name="ProductGoldenAgeImage" Type="String" />
            <asp:Parameter Name="IsAvailable" Type="String" />
            <asp:Parameter Name="Priority" Type="String" />
            <asp:Parameter Name="ProductID" Type="String" />
        </InsertParameters>
        <SelectParameters>
            <asp:ControlParameter ControlID="txtSearchProductGoldenAgeName" Name="ProductGoldenAgeName"
