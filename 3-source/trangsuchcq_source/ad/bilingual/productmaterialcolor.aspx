<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="productmaterialcolor.aspx.cs" Inherits="ad_single_partner" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
    ...
    <asp:RadAjaxPanel ID="RadAjaxPanel1" runat="server" ClientEvents-OnRequestStart="conditionalPostback">
        <asp:Panel ID="pnlSearch" DefaultButton="btnSearch" runat="server" Visible="false">
            ...
            <table class="search">
                <tr>
                    ...
                    <td>
                        <asp:RadTextBox ID="txtSearchProductMaterialColorName" runat="server" Width="200px">
                        </asp:RadTextBox>
                    </td>
                </tr>
            </table>
        ...
        <asp:RadGrid ID="RadGrid1" AllowMultiRowSelection="True" runat="server" Culture="vi-VN"
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                DataKeyNames="ProductMaterialColorID">
                ...
                <Columns>
                    ...
                    <asp:GridTemplateColumn HeaderStyle-Width="1%" HeaderText="STT">
                        <ItemTemplate>
                            ...
                            <asp:HiddenField ID="hdnProductMaterialColorID" runat="server" Value='<%# Eval("ProductMaterialColorID") %>' />
                            <asp:HiddenField ID="hdnProductMaterialColorImage" runat="server" Value='<%# Eval("ProductMaterialColorImage") %>' />
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    <asp:GridBoundColumn HeaderText="ID" DataField="ProductMaterialColorID" SortExpression="ProductMaterialColorID" Visible="false">
                    </asp:GridBoundColumn>
                    <asp:GridTemplateColumn HeaderText="Tên Màu Chất Liệu" DataField="ProductMaterialColorName"
                        SortExpression="ProductMaterialColorName">
                        <ItemTemplate>
                            <asp:Label ID="lblProductMaterialColorName" runat="server" Text='<%# Eval("ProductMaterialColorName")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    <asp:GridTemplateColumn HeaderText="Tên Màu Chất Liệu(Tiếng Anh)" Visible="false"
                        DataField="ProductMaterialColorNameEn" SortExpression="ProductMaterialColorNameEn">
                        <ItemTemplate>
                            <asp:Label ID="lblProductMaterialColorNameEn" runat="server" Text='<%# Eval("ProductMaterialColorNameEn")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    ...
                    <asp:GridTemplateColumn DataField="ProductMaterialColorImage" HeaderText="Ảnh"
                        SortExpression="ProductMaterialColorImage" Visible="false">
                        <ItemTemplate>
                            <asp:Panel ID="Panel1" runat="server" Visible='<%# string.IsNullOrEmpty( Eval("ProductMaterialColorImage").ToString()) ? false : true %>'
                                Width="95">
                                <img alt="" src='<%# "~/res/ProductMaterialColor/" + Eval("ProductMaterialColorImage") %>' width="80"
                                    runat="server" visible='<%# string.IsNullOrEmpty(Eval("ProductMaterialColorImage").ToString()) ? false : true %>' />
                                <asp:LinkButton ID="lnkDeleteImage" runat="server" rel='<%#  Eval("ProductMaterialColorID") + "#" + Eval("ProductMaterialColorImage") %>'
                            ...
                            <table class="search">
                                <tr class="invisible">
                                    ...
                                    <td>
                                        <asp:HiddenField ID="hdnProductMaterialColorID" runat="server" Value='<%# Eval("ProductMaterialColorID") %>' />
                                        <asp:HiddenField ID="hdnProductMaterialColorImage" runat="server" Value='<%# Eval("ProductMaterialColorImage") %>' />
                                        <asp:RadUpload ID="FileProductMaterialColorImage" runat="server" ControlObjectsVisibility="None"
                                ...
                                <tr>
                                    <td class="left" valign="top">Tên Màu Chất Liệu
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtProductMaterialColorName" runat="server" Text='<%# Bind("ProductMaterialColorName") %>'
                                ...
                                <asp:Panel ID="Panel2" runat="server" Visible="false">
                                    ...
                                    <tr>
                                        <td class="left" valign="top">Tên Màu Chất Liệu(En)
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtProductMaterialColorNameEn" runat="server" Text='<%# Bind("ProductMaterialColorNameEn") %>'
                                                Width="500px"></asp:TextBox>
                                        </td>
                                    </tr>
                                </asp:Panel>
        ...
        <asp:RadInputManager ID="RadInputManager1" runat="server">
            <asp:TextBoxSetting EmptyMessage="Tên Màu Chất Liệu ...">
                <TargetControls>
                    <asp:TargetInput ControlID="txtProductMaterialColorName" />
                </TargetControls>
            </asp:TextBoxSetting>
            <asp:TextBoxSetting EmptyMessage="Tên Màu Chất Liệu(En) ...">
                <TargetControls>
                    <asp:TargetInput ControlID="txtProductMaterialColorNameEn" />
                </TargetControls>
            </asp:TextBoxSetting>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="ProductMaterialColorDelete"
        SelectMethod="ProductMaterialColorSelectAll" TypeName="TLLib.ProductMaterialColor" UpdateMethod="ProductMaterialColorUpdate"
        InsertMethod="ProductMaterialColorInsert">
        <DeleteParameters>
            <asp:Parameter Name="ProductMaterialColorID" Type="String" />
        </DeleteParameters>
        <InsertParameters>
            <asp:Parameter Name="ProductMaterialColorName" Type="String" />
            <asp:Parameter Name="ProductMaterialColorNameEn" Type="String" />
            <asp:Parameter Name="ConvertedProductMaterialColorName" Type="String" />
            <asp:Parameter Name="ProductMaterialColorImage" Type="String" />
            <asp:Parameter Name="IsAvailable" Type="String" />
            <asp:Parameter Name="Priority" Type="String" />
            <asp:Parameter Name="ProductID" Type="String" />
        </InsertParameters>
        <SelectParameters>
            <asp:ControlParameter ControlID="txtSearchProductMaterialColorName" Name="ProductMaterialColorName"
