<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="productspecies.aspx.cs" Inherits="ad_single_partner" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
    ...
    <asp:RadAjaxPanel ID="RadAjaxPanel1" runat="server" ClientEvents-OnRequestStart="conditionalPostback">
        <asp:Panel ID="pnlSearch" DefaultButton="btnSearch" runat="server" Visible="false">
            ...
            <table class="search">
                <tr>
                    ...
                    <td>
                        <asp:RadTextBox ID="txtSearchProductSpeciesName" runat="server" Width="200px">
                        </asp:RadTextBox>
                    </td>
                </tr>
            </table>
                ...
                <Columns>
                    ...
                    <asp:GridTemplateColumn HeaderStyle-Width="1%" HeaderText="STT">
                        <ItemTemplate>
                            ...
                            <asp:HiddenField ID="hdnProductSpeciesID" runat="server" Value='<%# Eval("ProductSpeciesID") %>' />
                            <asp:HiddenField ID="hdnProductSpeciesImage" runat="server" Value='<%# Eval("ProductSpeciesImage") %>' />
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    <asp:GridBoundColumn HeaderText="ID" DataField="ProductSpeciesID" SortExpression="ProductSpeciesID" Visible="false">
                    </asp:GridBoundColumn>
                    <asp:GridTemplateColumn HeaderText="Tên Chủng Loại" DataField="ProductSpeciesName"
                        SortExpression="ProductSpeciesName">
                        <ItemTemplate>
                            <asp:Label ID="lblProductSpeciesName" runat="server" Text='<%# Eval("ProductSpeciesName")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    <asp:GridTemplateColumn HeaderText="Tên Chủng Loại(Tiếng Anh)" Visible="false"
                        DataField="ProductSpeciesNameEn" SortExpression="ProductSpeciesNameEn">
                        <ItemTemplate>
                            <asp:Label ID="lblProductSpeciesNameEn" runat="server" Text='<%# Eval("ProductSpeciesNameEn")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    ...
                    <asp:GridTemplateColumn DataField="ProductSpeciesImage" HeaderText="Ảnh"
                        SortExpression="ProductSpeciesImage" Visible="false">
                        <ItemTemplate>
                            <asp:Panel ID="Panel1" runat="server" Visible='<%# string.IsNullOrEmpty( Eval("ProductSpeciesImage").ToString()) ? false : true %>'
                                Width="95">
                                <img alt="" src='<%# "~/res/ProductSpecies/" + Eval("ProductSpeciesImage") %>' width="80"
                                    runat="server" visible='<%# string.IsNullOrEmpty(Eval("ProductSpeciesImage").ToString()) ? false : true %>' />
                                <asp:LinkButton ID="lnkDeleteImage" runat="server" rel='<%#  Eval("ProductSpeciesID") + "#" + Eval("ProductSpeciesImage") %>'
                ...
                <EditFormSettings EditFormType="Template">
                    <FormTemplate>
                        <asp:Panel ID="Panel1" runat="server" DefaultButton="lnkUpdate">
                            <h3 class="searchTitle">Thông Tin Chủng Loại</h3>
                            <table class="search">
                                <tr class="invisible">
                                    ...
                                    <td>
                                        <asp:HiddenField ID="hdnProductSpeciesID" runat="server" Value='<%# Eval("ProductSpeciesID") %>' />
                                        <asp:HiddenField ID="hdnProductSpeciesImage" runat="server" Value='<%# Eval("ProductSpeciesImage") %>' />
                                        <asp:RadUpload ID="FileProductSpeciesImage" runat="server" ControlObjectsVisibility="None"
                                ...
                                <tr>
                                    <td class="left" valign="top">Tên Chủng Loại
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtProductSpeciesName" runat="server" Text='<%# Bind("ProductSpeciesName") %>'
                                ...
                                <asp:Panel ID="Panel2" runat="server" Visible="false">
                                    ...
                                    <tr>
                                        <td class="left" valign="top">Tên Chủng Loại(En)
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtProductSpeciesNameEn" runat="server" Text='<%# Bind("ProductSpeciesNameEn") %>'
                                                Width="500px"></asp:TextBox>
                                        </td>
                                    </tr>
                                </asp:Panel>
        ...
        <asp:RadInputManager ID="RadInputManager1" runat="server">
            <asp:TextBoxSetting EmptyMessage="Tên Chủng Loại ...">
                <TargetControls>
                    <asp:TargetInput ControlID="txtProductSpeciesName" />
                </TargetControls>
            </asp:TextBoxSetting>
            <asp:TextBoxSetting EmptyMessage="Tên Chủng Loại(En) ...">
                <TargetControls>
                    <asp:TargetInput ControlID="txtProductSpeciesNameEn" />
                </TargetControls>
            </asp:TextBoxSetting>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="ProductSpeciesDelete"
        SelectMethod="ProductSpeciesSelectAll" TypeName="TLLib.ProductSpecies" UpdateMethod="ProductSpeciesUpdate"
        InsertMethod="ProductSpeciesInsert">
        <DeleteParameters>
            <asp:Parameter Name="ProductSpeciesID" Type="String" />
        </DeleteParameters>
        <InsertParameters>
            <asp:Parameter Name="ProductSpeciesName" Type="String" />
            <asp:Parameter Name="ProductSpeciesNameEn" Type="String" />
            <asp:Parameter Name="ConvertedProductSpeciesName" Type="String" />
            <asp:Parameter Name="ProductSpeciesImage" Type="String" />
            <asp:Parameter Name="IsAvailable" Type="String" />
            <asp:Parameter Name="Priority" Type="String" />
            <asp:Parameter Name="ProductID" Type="String" />
        </InsertParameters>
        <SelectParameters>
            <asp:ControlParameter ControlID="txtSearchProductSpeciesName" Name="ProductSpeciesName"
