<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="productstonecategory.aspx.cs" Inherits="ad_single_partner" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
    ...
    <asp:RadAjaxPanel ID="RadAjaxPanel1" runat="server" ClientEvents-OnRequestStart="conditionalPostback">
        <asp:Panel ID="pnlSearch" DefaultButton="btnSearch" runat="server" Visible="false">
            ...
            <table class="search">
                <tr>
                    ...
                    <td>
                        <asp:RadTextBox ID="txtSearchProductStoneCategoryName" runat="server" Width="200px">
                        </asp:RadTextBox>
                    </td>
                </tr>
            </table>
        ...
        <asp:RadGrid ID="RadGrid1" AllowMultiRowSelection="True" runat="server" Culture="vi-VN"
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                DataKeyNames="ProductStoneCategoryID">
                ...
                <Columns>
                    ...
                    <asp:GridTemplateColumn HeaderStyle-Width="1%" HeaderText="STT">
                        <ItemTemplate>
                            ...
                            <asp:HiddenField ID="hdnProductStoneCategoryID" runat="server" Value='<%# Eval("ProductStoneCategoryID") %>' />
                            <asp:HiddenField ID="hdnProductStoneCategoryImage" runat="server" Value='<%# Eval("ProductStoneCategoryImage") %>' />
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    <asp:GridBoundColumn HeaderText="ID" DataField="ProductStoneCategoryID" SortExpression="ProductStoneCategoryID" Visible="false">
                    </asp:GridBoundColumn>
                    <asp:GridTemplateColumn HeaderText="Tên Loại Đá Chính" DataField="ProductStoneCategoryName"
                        SortExpression="ProductStoneCategoryName">
                        <ItemTemplate>
                            <asp:Label ID="lblProductStoneCategoryName" runat="server" Text='<%# Eval("ProductStoneCategoryName")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    <asp:GridTemplateColumn HeaderText="Tên Loại Đá Chính(Tiếng Anh)" Visible="false"
                        DataField="ProductStoneCategoryNameEn" SortExpression="ProductStoneCategoryNameEn">
                        <ItemTemplate>
                            <asp:Label ID="lblProductStoneCategoryNameEn" runat="server" Text='<%# Eval("ProductStoneCategoryNameEn")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    ...
                    <asp:GridTemplateColumn DataField="ProductStoneCategoryImage" HeaderText="Ảnh"
                        SortExpression="ProductStoneCategoryImage" Visible="false">
                        <ItemTemplate>
                            <asp:Panel ID="Panel1" runat="server" Visible='<%# string.IsNullOrEmpty( Eval("ProductStoneCategoryImage").ToString()) ? false : true %>'
                                Width="95">
                                <img alt="" src='<%# "~/res/ProductStoneCategory/" + Eval("ProductStoneCategoryImage") %>' width="80"
                                    runat="server" visible='<%# string.IsNullOrEmpty(Eval("ProductStoneCategoryImage").ToString()) ? false : true %>' />
                                <asp:LinkButton ID="lnkDeleteImage" runat="server" rel='<%#  Eval("ProductStoneCategoryID") + "#" + Eval("ProductStoneCategoryImage") %>'
                ...
                <EditFormSettings EditFormType="Template">
                    <FormTemplate>
                        <asp:Panel ID="Panel1" runat="server" DefaultButton="lnkUpdate">
                            <h3 class="searchTitle">Thông Tin Loại Đá Chính</h3>
                            <table class="search">
                                <tr class="invisible">
                                    ...
                                    <td>
                                        <asp:HiddenField ID="hdnProductStoneCategoryID" runat="server" Value='<%# Eval("ProductStoneCategoryID") %>' />
                                        <asp:HiddenField ID="hdnProductStoneCategoryImage" runat="server" Value='<%# Eval("ProductStoneCategoryImage") %>' />
                                        <asp:RadUpload ID="FileProductStoneCategoryImage" runat="server" ControlObjectsVisibility="None"
                                ...
                                <tr>
                                    <td class="left" valign="top">Tên Loại Đá Chính
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtProductStoneCategoryName" runat="server" Text='<%# Bind("ProductStoneCategoryName") %>'
                                ...
                                <asp:Panel ID="Panel2" runat="server" Visible="false">
                                    ...
                                    <tr>
                                        <td class="left" valign="top">Tên Loại Đá Chính(En)
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtProductStoneCategoryNameEn" runat="server" Text='<%# Bind("ProductStoneCategoryNameEn") %>'
                                                Width="500px"></asp:TextBox>
                                        </td>
                                    </tr>
                                </asp:Panel>
        ...
        <asp:RadInputManager ID="RadInputManager1" runat="server">
            <asp:TextBoxSetting EmptyMessage="Tên Loại Đá Chính ...">
                <TargetControls>
                    <asp:TargetInput ControlID="txtProductStoneCategoryName" />
                </TargetControls>
            </asp:TextBoxSetting>
            <asp:TextBoxSetting EmptyMessage="Tên Loại Đá Chính(En) ...">
                <TargetControls>
                    <asp:TargetInput ControlID="txtProductStoneCategoryNameEn" />
                </TargetControls>
            </asp:TextBoxSetting>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="ProductStoneCategoryDelete"
        SelectMethod="ProductStoneCategorySelectAll" TypeName="TLLib.ProductStoneCategory" UpdateMethod="ProductStoneCategoryUpdate"
        InsertMethod="ProductStoneCategoryInsert">
        <DeleteParameters>
            <asp:Parameter Name="ProductStoneCategoryID" Type="String" />
        </DeleteParameters>
        <InsertParameters>
            <asp:Parameter Name="ProductStoneCategoryName" Type="String" />
            <asp:Parameter Name="ProductStoneCategoryNameEn" Type="String" />
            <asp:Parameter Name="ConvertedProductStoneCategoryName" Type="String" />
            <asp:Parameter Name="ProductStoneCategoryImage" Type="String" />
            <asp:Parameter Name="IsAvailable" Type="String" />
            <asp:Parameter Name="Priority" Type="String" />
            <asp:Parameter Name="ProductID" Type="String" />
        </InsertParameters>
        <SelectParameters>
            <asp:ControlParameter ControlID="txtSearchProductStoneCategoryName" Name="ProductStoneCategoryName"
