<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="productstonecolor.aspx.cs" Inherits="ad_single_partner" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
    ...
    <asp:RadAjaxPanel ID="RadAjaxPanel1" runat="server" ClientEvents-OnRequestStart="conditionalPostback">
        <asp:Panel ID="pnlSearch" DefaultButton="btnSearch" runat="server" Visible="false">
            ...
            <table class="search">
                <tr>
                    ...
                    <td>
                        <asp:RadTextBox ID="txtSearchProductStoneColorName" runat="server" Width="200px">
                        </asp:RadTextBox>
                    </td>
                </tr>
            </table>
        ...
        <asp:RadGrid ID="RadGrid1" AllowMultiRowSelection="True" runat="server" Culture="vi-VN"
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                DataKeyNames="ProductStoneColorID">
                ...
                <Columns>
                    ...
                    <asp:GridTemplateColumn HeaderStyle-Width="1%" HeaderText="STT">
                        <ItemTemplate>
                            ...
                            <asp:HiddenField ID="hdnProductStoneColorID" runat="server" Value='<%# Eval("ProductStoneColorID") %>' />
                            <asp:HiddenField ID="hdnProductStoneColorImage" runat="server" Value='<%# Eval("ProductStoneColorImage") %>' />
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    <asp:GridBoundColumn HeaderText="ID" DataField="ProductStoneColorID" SortExpression="ProductStoneColorID" Visible="false">
                    </asp:GridBoundColumn>
                    <asp:GridTemplateColumn HeaderText="Màu Đá Chính" DataField="ProductStoneColorName"
                        SortExpression="ProductStoneColorName">
                        <ItemTemplate>
                            <asp:Label ID="lblProductStoneColorName" runat="server" Text='<%# Eval("ProductStoneColorName")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    <asp:GridTemplateColumn HeaderText="Màu Đá Chính(Tiếng Anh)" Visible="false"
                        DataField="ProductStoneColorNameEn" SortExpression="ProductStoneColorNameEn">
                        <ItemTemplate>
                            <asp:Label ID="lblProductStoneColorNameEn" runat="server" Text='<%# Eval("ProductStoneColorNameEn")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    ...
                    <asp:GridTemplateColumn DataField="ProductStoneColorImage" HeaderText="Ảnh"
                        SortExpression="ProductStoneColorImage" Visible="false">
                        <ItemTemplate>
                            <asp:Panel ID="Panel1" runat="server" Visible='<%# string.IsNullOrEmpty( Eval("ProductStoneColorImage").ToString()) ? false : true %>'
                                Width="95">
                                <img alt="" src='<%# "~/res/ProductStoneColor/" + Eval("ProductStoneColorImage") %>' width="80"
                                    runat="server" visible='<%# string.IsNullOrEmpty(Eval("ProductStoneColorImage").ToString()) ? false : true %>' />
                                <asp:LinkButton ID="lnkDeleteImage" runat="server" rel='<%#  Eval("ProductStoneColorID") + "#" + Eval("ProductStoneColorImage") %>'
                ...
                <EditFormSettings EditFormType="Template">
                    <FormTemplate>
                        <asp:Panel ID="Panel1" runat="server" DefaultButton="lnkUpdate">
                            <h3 class="searchTitle">Thông Tin Màu Đá Chính</h3>
                            <table class="search">
                                <tr class="invisible">
                                    ...
                                    <td>
                                        <asp:HiddenField ID="hdnProductStoneColorID" runat="server" Value='<%# Eval("ProductStoneColorID") %>' />
                                        <asp:HiddenField ID="hdnProductStoneColorImage" runat="server" Value='<%# Eval("ProductStoneColorImage") %>' />
                                        <asp:RadUpload ID="FileProductStoneColorImage" runat="server" ControlObjectsVisibility="None"
                                ...
                                <tr>
                                    <td class="left" valign="top">Tên Màu Đá Chính
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtProductStoneColorName" runat="server" Text='<%# Bind("ProductStoneColorName") %>'
                                ...
                                <asp:Panel ID="Panel2" runat="server" Visible="false">
                                    ...
                                    <tr>
                                        <td class="left" valign="top">Tên Màu Đá Chính(En)
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtProductStoneColorNameEn" runat="server" Text='<%# Bind("ProductStoneColorNameEn") %>'
                                                Width="500px"></asp:TextBox>
                                        </td>
                                    </tr>
                                </asp:Panel>
        ...
        <asp:RadInputManager ID="RadInputManager1" runat="server">
            <asp:TextBoxSetting EmptyMessage="Tên Màu Đá Chính ...">
                <TargetControls>
                    <asp:TargetInput ControlID="txtProductStoneColorName" />
                </TargetControls>
            </asp:TextBoxSetting>
            <asp:TextBoxSetting EmptyMessage="Tên Màu Đá Chính(En) ...">
                <TargetControls>
                    <asp:TargetInput ControlID="txtProductStoneColorNameEn" />
                </TargetControls>
            </asp:TextBoxSetting>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="ProductStoneColorDelete"
        SelectMethod="ProductStoneColorSelectAll" TypeName="TLLib.ProductStoneColor" UpdateMethod="ProductStoneColorUpdate"
        InsertMethod="ProductStoneColorInsert">
        <DeleteParameters>
            <asp:Parameter Name="ProductStoneColorID" Type="String" />
        </DeleteParameters>
        <InsertParameters>
            <asp:Parameter Name="ProductStoneColorName" Type="String" />
            <asp:Parameter Name="ProductStoneColorNameEn" Type="String" />
            <asp:Parameter Name="ConvertedProductStoneColorName" Type="String" />
            <asp:Parameter Name="ProductStoneColorImage" Type="String" />
            <asp:Parameter Name="IsAvailable" Type="String" />
            <asp:Parameter Name="Priority" Type="String" />
            <asp:Parameter Name="ProductID" Type="String" />
        </InsertParameters>
        <SelectParameters>
            <asp:ControlParameter ControlID="txtSearchProductStoneColorName" Name="ProductStoneColorName"
