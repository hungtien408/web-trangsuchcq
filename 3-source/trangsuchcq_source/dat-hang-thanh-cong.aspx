...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <div id="site" class="corner">
        <div class="container">
            <a href="~/" runat="server">Trang chủ</a> <span class="fa fa-angle-right"></span><a href="#">Đá quý</a> <span class="fa fa-angle-right"></span><a href="#">Bộ sản phẩm Ruby vàng trắng 14K</a> <span class="fa fa-chevron-right"></span><a href="#">Giỏ hàng</a> <span class="fa fa-chevron-right"></span><span>Thanh toán</span>
        </div>
    </div>
    <div class="mua-content container">
        <section>
            <h3 class="dathangthanhcong text-uppercase">Đặt hàng thành công</h3>
