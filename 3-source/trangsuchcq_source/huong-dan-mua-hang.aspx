<%@ Page Title="" Language="C#" MasterPageFile="~/site-sub.master" AutoEventWireup="true" CodeFile="huong-dan-mua-hang.aspx.cs" Inherits="cau_hoi_thuong_gap" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <asp:ObjectDataSource ID="odsSupportDetail" runat="server" SelectMethod="ProductSelectOne"
        TypeName="TLLib.Product">
        <SelectParameters>
            <asp:QueryStringParameter Name="ProductID" QueryStringField="ht" Type="String" />
        </SelectParameters>
    </asp:ObjectDataSource>
</asp:Content>
