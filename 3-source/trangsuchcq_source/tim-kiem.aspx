<%@ Page Title="" Language="C#" MasterPageFile="~/site-sub.master" AutoEventWireup="true" CodeFile="tim-kiem.aspx.cs" Inherits="cau_hoi_thuong_gap" %>
        ...
        <ul class="search-sp">
            ...
            <li><a href="#">Loại đá chính<span class="icon-right fa fa-caret-down"></span></a>
                <asp:ListView ID="lstProductStoneCategory" runat="server" DataSourceID="odsProductStoneCategory"
                    EnableModelValidation="True">
                    <ItemTemplate>
                        <li><a href='<%# "tim-kiem.aspx?ps=" + Eval("ProductStoneCategoryID") %>'><%# Eval("ProductStoneCategoryName") %></a></li>
                    </ItemTemplate>
                    <LayoutTemplate>
                        <ul>
                            <li runat="server" id="itemPlaceholder"></li>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div class="pro-cate trangdiem-cate">
                ...
                <asp:ObjectDataSource ID="odsProduct" runat="server" SelectMethod="ProductSelectAll1"
                    ...
                    <SelectParameters>
                        ...
                        <asp:QueryStringParameter QueryStringField="pf" Name="PriceFrom" Type="String" />
                        <asp:QueryStringParameter QueryStringField="pt" Name="PriceTo" Type="String" />
                        <asp:QueryStringParameter DefaultValue="3" QueryStringField="pci" Name="CategoryID" Type="String" />
                        <asp:QueryStringParameter QueryStringField="mar" Name="ManufacturerID" Type="String" />
                        <asp:QueryStringParameter QueryStringField="sex" Name="ProductGenderID" Type="String" />
                        <asp:QueryStringParameter QueryStringField="marc" Name="ProductMaterialColorID" Type="String" />
                        <asp:QueryStringParameter QueryStringField="ps" Name="ProductSpeciesID" Type="String" />
                        <asp:QueryStringParameter QueryStringField="psc" Name="ProductStoneColorID" Type="String" />
                        <asp:QueryStringParameter QueryStringField="psca" Name="ProductStoneCategoryID" Type="String" />
                        <asp:QueryStringParameter QueryStringField="pga" Name="ProductGoldenAgeID" Type="String" />
